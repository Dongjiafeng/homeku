...
public class T {
	...
	private String sendAddr = "daong827816736";//这是发送方的邮箱
//	private String receiveAddr = "1060048901@qq.com";//接收方的邮箱

	//这个不是密码,是开启163邮箱第三方登录时候设置的授权码
	//如果不开启,那么是无法第三方登录163邮箱账号的
	private String pass = "ddntrvxxtsykbeeg";
...
//		msg.setFrom(new InternetAddress(sendAddr+"@qq.com"));
//		// 设置收件人
//		msg.setRecipients(Message.RecipientType.TO, "1060048901@qq.com");
