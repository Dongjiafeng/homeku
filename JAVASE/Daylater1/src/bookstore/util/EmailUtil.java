...
//	@Test
	public String t1(String email) throws MessagingException {
...
//		prop.put("mail.transport.protocol", "smtp");
		...
		//添加主题
		msg.setSubject("这是来自你爸爸的文件,儿子注意查收");

		String eid = UUID.randomUUID().toString().replaceAll("-", "");

		//添加内容,第二个参数表示这是html的内容
		msg.setContent("<h1>此邮件为官方激活邮件！请点击下面链接完成激活操作！</h1><h3><a href='http://localhost:8080/uid?code="+eid+"'>http://localhost:8080/uid</a></h3>","text/html;charset=UTF-8");
